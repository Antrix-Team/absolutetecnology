...
import { GetProductById, UpdateProduct } from "../../api/ProductListProvider/ProductListProvider";
...
export const EditProductForm = ({productId}) => {
  ...
  const getProduct = async(productId) => {
    try {
      ...
      setUpdateProduct({name: response.name, description: response.description, brand: response.brand, price: response.price});
  ...
  const fetchCategories = async() => {
    try {
      console.log("VALUE OF SELECT CATEGORY",selectCategory)
